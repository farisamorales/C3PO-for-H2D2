...
"""-----------------------------------"""
print 'First loop, 100 iterations'
loop = 0
while loop < 100:
    loop += 1
...
print 'Second loop, 100 iterations'
loop = 0
while loop < 100:
    loop += 1
...
"""-----------------------------------"""
"""-----------------------------------"""
print 'Third loop, 100 iterations'
loop_Norms = 0
...
#------------------------------------------------------------------------------ 
#------------------------------------------------------------------------------ 
print 'Fourth loop, 100 iterations'
T_loop = 0
while T_loop < 100:
    T_loop += 1       
...
print 'Fifth loop, 200 iterations'
loop_2 = 0
while loop_2 < 200:
    loop_2 += 1                        
...
#------------------------------------------------------------------------------ 
#------------------------------------------------------------------------------ 
print 'Sixth loop, 100 iterations'
T_loop_2 = 0
while T_loop_2 < 100:
    T_loop_2 += 1       
...
"""----------------------------END LOOP 2-----------------------------------"""   
"""------------------------------LOOP 3-------------------------------------"""
print 'Seventh loop, 10X300 Long iterations'
Loop_3 = 0
while Loop_3 < 10:
    Loop_3 += 1
    print Loop_3
...
Re_Chi = Chi/(len(x)-4)
"""-----------------------------CHI VALUE-----------------------------------"""
Parameters = [Norm, T_cold, Norm_cold, T_hot, Norm_hot]

print 'Star Normalizer', Norm
print 'Cold Temperature', T_cold
print 'Cold Normalizer', Norm_cold
print 'Hot Temperature', T_hot
print 'Hot Normalizer', Norm_hot
print 'Reduced Chi value', Re_Chi
